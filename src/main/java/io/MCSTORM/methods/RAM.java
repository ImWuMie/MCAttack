...
public class RAM implements Method {
    ...
    public void accept(Channel channel, ProxyLoader.Proxy proxy) {
        ...
        try {
            channel.writeAndFlush(Unpooled.buffer().writeBytes((new LoginRequest("FLEX_OK_" + RandomUtils.randomUTF16String1(8))).getWrappedPacket()));
